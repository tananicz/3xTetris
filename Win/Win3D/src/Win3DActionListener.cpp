...
namespace Win3D
{
    Win3DActionListener::Win3DActionListener(HWND windowHandle)
    {
        _windowHandle = windowHandle;
    }

    IAction* Win3DActionListener::listenForAction(bool waitForInput)
    {
        ...
        if (PeekMessage(&msg, _windowHandle, 0, 0, PM_REMOVE))
        {
            ...
            case WM_KEYDOWN:
                ...
                case VK_UP:
                    return createAction(MoveUp);
                case VK_DOWN:
                    return createAction(MoveDown);
                case 0x31:
                    return createAction(RotateXCW);
                case 0x51:
                    return createAction(RotateXCCW);
                case 0x32:
                    return createAction(RotateYCW);
                case 0x57:
                    return createAction(RotateYCCW);
                case 0x33:
                    return createAction(RotateZCW);
                case 0x45:
                    return createAction(RotateZCCW);
                case 0x20:
                    return createAction(PushDown);
                default:
                    return nullptr;
                }
            case WM_PAINT:
    ...
    IAction* Win3DActionListener::createAction(Win3DActionEnum actionName)
    {
        Win3DAction* action = new Win3DAction;
